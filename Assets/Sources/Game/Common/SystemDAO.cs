...
public class SystemDAO : SingleTon<SystemDAO> {
    ...
    public class MapManager
    {
        ...
        {
            bool send_bool = false;
            float point = boss_point;
            float disable_point_min = Define.boss_disable_point.min + player_point;
            float disable_point_max = Define.boss_disable_point.max + player_point;
    ...
    public class FileManager
    {
        ...
        {
            public float regen_term = Define.DayCount_Cycle;

            public void Init()
            {
                regen_term = Define.DayCount_Cycle;
            }
        }
