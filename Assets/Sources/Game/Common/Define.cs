...
public static class Define{
    ...
    //날짜 / 밤낮 / 폭풍 주기
    public const float DayCount_Cycle = 200f;
    ...
    public static float Storm_Enable_Cycle = Random.Range(Day_Cycle - Day_1D3_Cycle, Day_Cycle);
    public static float Storm_Cool_Cycle = Random.Range(Day_Cycle + Day_1D3_Cycle, DayCount_Cycle * 2);

    //난이도 변경
    public const int Secotr1_Open_Day = 3;
    public const int Secotr2_Open_Day = 10;
    ...
    public static int artifact_move_rate = 1;
    public static int artifact_tree_rate = 1;
    public static int artifact_rock_rate = 1;
    public static int artifact_slime_rate = 100;
    public static int artifact_sand_rate = 200;
    ...
    public const float spaceship_recovery = 1f; 
    #endregion
    ...
    //갯수 제한
    public const int turret_num_limit = 10;
    public const int shield_num_limit = 10;
    public const int regenerator_num_limit = 4;
    public const int build_num_limit = turret_num_limit + shield_num_limit + regenerator_num_limit; 
    #endregion
    ...
    //몬스터 리젠 시간
    public static float monster_regen_term_min = 25f;
    public static float monster_regen_term_max = 45f;
    public static float monster_regen_term = 20.0f;
