...
public class GameDAO : SingleTon<GameDAO> {
    ...
    //아머
    public class ArmorData : ConsumeData {
        public ArmorData() {
            buy_need = new SubstanceData(0, 0, 8);
        }
    }
    public ArmorData armor_data = new ArmorData();
    ...
    public class ArtifactData
    {
        ...
        public ArtifactData()
        {
                artifcat[0].description = "Attack 50% up";
                artifcat[1].description = "Speed 20% up";
                artifcat[2].description = "Tool Speed 20% up";
                artifcat[3].description = "Health 20% up";
                artifcat[4].description = "SweetPotato Recovery +100";
        }
