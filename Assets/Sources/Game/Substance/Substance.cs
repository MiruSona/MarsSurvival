...
public class Substance : MonoBehaviour {
    ...
    //크기에 따른 자원 값
    private readonly int small_value = 6;
    private readonly int medium_value = 12;      
    private readonly int large_value = 20;
    ...
    //SubstanceData Getter
    public GameDAO.SubstanceData GetSubstanceData()
    {
        return subdata;
    }
