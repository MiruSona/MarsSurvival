...
public abstract class MonsterCommon : MonoBehaviour {
    ...
    #region 공통
    //자원 랜덤 생성
    protected void CreateSubstance(Define.Range bio, Define.Range metal, Define.Range crystal, int _bio_drop_rate, int _metal_drop_rate, int _crystal_drop_rate)
    {
        //0 ~ 9999 까지 랜덤 생성
