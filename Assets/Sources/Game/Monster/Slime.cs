    ...
    protected override void Init()
    {
        switch (intensity)
        {
            ...
            case Intensity.Normal:
                ...
                switch (attack_style)
                {
                    case AttackStyle.Melee:
                        ...
                        monster_data.atk_melee = 104f;
                        monster_data.speed = 0.055f;
                        break;

                    case AttackStyle.Range:
                        monster_data.pool = GameDAO.MonsterData.Pool.Slime_Normal_Range;
                        monster_data.atk_melee = 65f;
                        monster_data.atk_range = 104f;
                        monster_data.atk_range_timer.term = 2f;
                        monster_data.atk_range_timer.timer = monster_data.atk_range_timer.term;
                        monster_data.speed = 0.035f;
                        break;
            ...
            case Intensity.Strong:
                ...
                crystal_range.min = 1; crystal_range.max = 2;
        ...
        if(intensity != Intensity.Strong)
            CreateSubstance(bio_range, metal_range, crystal_range, bio_drop_rate, metal_drop_rate, 0);
        else
            CreateSubstance(bio_range, metal_range, crystal_range, bio_drop_rate, metal_drop_rate, 1);
