...
public class AlienBoss : SPBossCommon {
    ...
    private const float pos_y_offset = -0.86f;
    ...
    protected override void Init()
    {
        ...
        //총알 관련 초기화
        //총알 가져옴
        bullet_prefab = Resources.Load<GameObject>("Prefab/Game/SPBoss/Bullet/Alien_Bullet");
        ...
        range_attack_sound = Resources.Load<AudioClip>("Sound/SoundEffect/AlienAttack");
    ...
    protected override void RegenInit()
    {
        ...
        //스탯 초기화
        sp_boss_data.hp_max = 2500f;
        sp_boss_data.hp = 2500f;
        sp_boss_data.speed = 0.055f;

        sp_boss_data.atk = 210f;
        sp_boss_data.melee_atk_timer.term = 0.1f;
        sp_boss_data.range_atk_timer.term = 1.0f;
        if (file_manager.hard_mod)
            sp_boss_data.atk *= Define.hard_alien_spboss;

        //자원 양 및 확률 초기화
        bio_range.min = 400; bio_range.max = 402;
        metal_range.min = 400; metal_range.max = 402;
